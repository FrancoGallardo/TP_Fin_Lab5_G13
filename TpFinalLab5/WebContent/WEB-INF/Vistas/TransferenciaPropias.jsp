				...
				<form method="post" action="transferMyAccount.do"
					...
					<div class="row">
						<div class="col-sm-6 right-column-content">
							<label for="txtCBUOrigen" class="label-cbu">Seleccione la
								Cuenta Origen</label>
						</div>
						<div class="col-sm-6 right-column-content">
						...
						<div class="col-sm-6 right-column-content">
							<label for="txtCBU" class="label-cbu">Seleccione la Cuenta Destino</label>
						</div>
						<div class="col-sm-6 right-column-content">
							<select id="ddlCBUDestino" name="ddlCBUDestino" class="selecter-account">
								<c:forEach items="${cuentas}" var="cuenta">
									<option id="txtCBU" value="${cuenta.getCBU()}">${cuenta.getCBU()}</option>
								</c:forEach>
							</select>
